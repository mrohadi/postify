        ...
        <div class="w-8/12 bg-white p-6 rounded-lg">
            <form action="{{ route('posts') }}" method="post" class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="body" id="body" cols="30" rows="3" class="bg-gray-100 border-2 w-full p-4 rounded-lg
                        @error('body')border-red-500 @enderror" placeholder="Your thought"></textarea>
